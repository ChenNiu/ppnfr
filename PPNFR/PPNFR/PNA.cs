...
namespace PPNFR
{
    class PNA
    {
        ...
        public void configMeasurement(double freq, int numPoint, double ifbw)
        {
            ...
            this.chan.IFBandwidth = ifbw; ;
            // set port 1 power level in dBm
            this.chan.TestPortPower[1] = 10;

            this.meas.Trace.ReferenceValue = -80;
