...
volatile float currentRaw; // the raw analogRead ranging from 0-1023
volatile float currentVolts; // raw reading changed to Volts
volatile float currentAmps; // Voltage reading changed to Amps
